...
void loop() {
  if (rcSwitch.available()) {
    ...
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11111111); //rowA
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11111110); //rowB
//    shiftOut(dataPin2, clockPin2, LSBFIRST, mask);
//    shiftOut(dataPin2, clockPin2, LSBFIRST, rw8);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1); //col1
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);  //col2
    shiftOut(dataPin3, clockPin3, MSBFIRST, col3);  //col3
  ...
  //  delay(100);
    ...
    digitalWrite(latchPin2, LOW);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11111111);  //rowA
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11111101);  //rowB
 //   shiftOut(dataPin2, clockPin2, LSBFIRST, mask);
 //   shiftOut(dataPin2, clockPin2, LSBFIRST, rw7);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);  //col1
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);  //col2
  ...
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, mask);
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, rw6);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
  ...
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, mask);
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, rw5);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
  ...
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, mask);
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, rw4);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
  ...
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, mask);
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, rw3);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
 ...
 //   shiftOut(dataPin2, clockPin2, LSBFIRST, mask);
 //   shiftOut(dataPin2, clockPin2, LSBFIRST, rw2);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
  ...
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, mask);
  //  shiftOut(dataPin2, clockPin2, LSBFIRST, rw1);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);

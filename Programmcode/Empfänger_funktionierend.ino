...
*  ELGS_72
*/
//Arduino UNO - Receiver - COM20 - Stand 28.04.2020
//Portbelegung:
//D2 - DataIn 433 MHz
//D4 - Data2 data2
//D5 - SH2 shift2
...
//Aufrufen des Receivers und des LCDs
...
long mask = B11111111;
long erase = B00000000;

int dataPin2 = 4;   //DS - Pin 14
int latchPin2 = 5;  //ST - Pin 13
int clockPin2 = 6;  //SH - Pin 12
int dataPin3 = 7;   //DS - Pin 14
int latchPin3 = 8;  //ST - Pin 13
int clockPin3 = 9;  //SH - Pin 12
//int led =
...
long d1r1, d1r2, d1r3, d1r4, d1r5, d1r6, d1r7, d1r8,
     ...
     r9  , rr10, rr11, rr12, rr13, rr14, rr15,
     col1, col2, colH, col3, rowA, rowB;
...
//endArray überall mit binärer 1 am Ende - bei shiftOut mit MSB
//entsteht ein Überhang an der ersten Stelle

void setup() {
  //Aufrufen der seriellen Schnittstelle
  Serial.begin(9600);
  //Interrupt zum Empfangen
  rcSwitch.enableReceive(0); 
  //Defintion der Augänge
...
void loop() {
  if (rcSwitch.available()) {
    //Status LED schaltet um beim Empfangen von Daten
    //digitalWrite(led, HIGH);
    //Ausgabe auf LCD/serieller Schnittstelle - Daten werden Empfangen
    Serial.println("Empfange...");
    lcd.clear();
    lcd.setCursor(0, 0);
    lcd.print("Empfange...");
    
    //Empfangenes erstes Zeichen der Datenübertragung - gespeichert auf Variable
    digit1 = rcSwitch.getReceivedValue();
    //Serielle Ausgabe des ersten Zeichens in HEX
    Serial.print("[");
    Serial.print(millis());
    Serial.print("] - ");
    Serial.print("1 - ");
    Serial.println(rcSwitch.getReceivedValue(), HEX);
    //Zurücksetzen des Empfängers, damit neue Daten empfangen werden können
    rcSwitch.resetAvailable();

    //Delay zur sicheren Überbrückung der Zeit zwischen den einzelnen Zeichen
    delay(1050);

    //Wiederholung des gleichen Vorgangs für alle 8 Zeichen
...
//    digitalWrite(led, LOW);
    ...
    shiftOut(dataPin2, clockPin2, MSBFIRST, mask);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11111110);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col3);
    ...
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, erase);
    shiftOut(dataPin3, clockPin3, MSBFIRST, erase);
    shiftOut(dataPin3, clockPin3, MSBFIRST, erase);
    digitalWrite(latchPin3, HIGH);
    ...
    digitalWrite(latchPin2, LOW);
    shiftOut(dataPin2, clockPin2, MSBFIRST, mask);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11111101);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
    ...
    digitalWrite(latchPin2, LOW);
    shiftOut(dataPin2, clockPin2, MSBFIRST, mask);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11111011);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
    ...
    digitalWrite(latchPin2, LOW);
    shiftOut(dataPin2, clockPin2, MSBFIRST, mask);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11110111);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
    ...
    digitalWrite(latchPin2, LOW);
    shiftOut(dataPin2, clockPin2, MSBFIRST, mask);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11101111);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
    ...
    digitalWrite(latchPin2, LOW);
    shiftOut(dataPin2, clockPin2, MSBFIRST, mask);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B11011111);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
    ...
    digitalWrite(latchPin2, LOW);
    shiftOut(dataPin2, clockPin2, MSBFIRST, mask);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B10111111);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
    ...
    digitalWrite(latchPin2, LOW);
    shiftOut(dataPin2, clockPin2, MSBFIRST, mask);
    shiftOut(dataPin2, clockPin2, MSBFIRST, B01111111);
    digitalWrite(latchPin2, HIGH);
    digitalWrite(latchPin3, LOW);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col1);
    shiftOut(dataPin3, clockPin3, MSBFIRST, col2);
